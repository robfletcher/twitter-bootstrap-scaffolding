			...
			<section id="main" class="span9">
				...
				<div class="row-fluid">
					...
					<div class="span4">
						...
						<p>To install this look &amp; feel into your Grails app we installed the following plugins:</p>
						<pre>runtime ':twitter-bootstrap:${applicationContext.getBean('pluginManager').getGrailsPlugin('twitter-bootstrap').version}'
runtime ':fields:${applicationContext.getBean('pluginManager').getGrailsPlugin('fields').version}'
runtime ':resources:${applicationContext.getBean('pluginManager').getGrailsPlugin('resources').version}'</pre>
						<p>The following files were copied to your project:</p>
